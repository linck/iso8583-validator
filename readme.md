...
| mandatoryIfNotExistsSubfield 	| String         | Não         | Valida o subcampo como obrigatório se o subcampo informado **não** existir                                                                                                                                                                                                                                                                                                                        |
...
| contentType               	| String 		 | Não         | Tipo do conteudo: - text - binary |
